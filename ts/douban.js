(() => {
  // <stdin>
  var DoubanCard = class {
    ele;
    subjectId;
    requestUrl;
    requestType;
    localData;
    constructor(ele, subjectId, requestUrl, requestType, data) {
      this.ele = ele;
    ...
    fetchData() {
      ...
      if (cacheItem == null || typeof cacheItem == "undefined") {
        fetch(this.requestUrl).then((response) => response.json()).then((data) => {
          let model = {};
          if (this.requestType == "movie") {
            model = {
                ...
                <div class="post-preview--middle">
                    ...
                    <div class="hexo-douban-rating">
                        <span class="all-star-dark">
                            <span class="all-star-light" style="width: ${model.vote * 10}%;"></span>
                        </span>
                        <span class="rating_nums">${model.vote}</span>
                    </div>
