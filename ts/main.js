(() => {
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\gallery.ts
  var StackGallery = class _StackGallery {
    ...
    loadItems(container) {
      ...
      for (const el of figures) {
        ...
        let aux = {
          w: parseInt(img.getAttribute("width")) || img.naturalWidth,
          h: parseInt(img.getAttribute("height")) || img.naturalHeight,
          src: img.src,
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\menu.ts
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\createElement.ts
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\colorScheme.ts
    ...
    bindClick(toggleEl) {
      toggleEl.addEventListener("click", (e) => {
        if (this.isDark()) {
          ...
          document.getElementById("dark-mode-text").innerText = "\u591C\u95F4\u6A21\u5F0F";
        } else {
          this.currentScheme = "dark";
          document.getElementById("dark-mode-text").innerText = "\u767D\u5929\u6A21\u5F0F";
        }
        this.setBodyClass();
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\scrollspy.ts
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\smoothAnchors.ts
  ...
  // ns-hugo:D:\Projects\hugo-blog\themes\hugo-theme-stack\assets\ts\lazyLoad.ts
  ...
  var lazyLoadByDefault = function(imgs) {
  ...
  var lazyLoadByObserver = function(lazyImages) {
        ...
        let observer = new IntersectionObserver(async (entries, observer2) => {
          entries.forEach((entry) => {
            ...
            articles.forEach(async (articles2) => {
              ...
              articleDetails.style.background = "transparent";
            });
          });
        });
